                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <h1 class="display-3 fw-bolder mb-5">👋<span class="text-gradient d-inline"> Plongez dans un monde de boomers, <br>et d'inspiration de y'a 15 ans ! </span></h1>
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="">
                                    ...
                                    <img class="img_brr" src="assets/design_3_red.png" width="600px" height="500px" alt="..." />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                <h2 class="display-5 fw-bolder">🌟<span class="text-gradient d-inline"> Bienvenue sur Fakebook, le réseau social où l'imagination dépasse la réalité ! </span>🌟</h2>
                                <br><p class="text-muted">Rejoignez-nous pour des discussions aussi absurdes que des chaussettes qui disparaissent dans la machine à laver, des débats enflammés sur la meilleure façon de manger une pizza, et des vidéos de chats qui dansent la macarena !</p>
                                <br><br>
                            </div>
                        </div>
                    </div>
