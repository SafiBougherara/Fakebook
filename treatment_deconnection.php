                        ...
                        <div class="col-xxl-8">
                            <div class="text-center my-5">
                                ...
                                <?php 
                                    ...
                                    ?><br><a href="sign_up.php"><button name="sign_up" class="btn btn-primary" type="submit">Sign up</button></a> ou <a href="sign_in.php"><button name="sign_in" class="btn btn-primary" type="submit">Sign in</button></a><?php
                                ?>
                                </h1>
                                </div>
                            </div>
