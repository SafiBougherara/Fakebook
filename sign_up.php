                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-xxl-8">
                            ...
                            <img src="assets/Profile.png" width="130" height="100" alt="...">
                                <h2 class="display-5 fw-bolder"><span class="text-gradient d-inline">Créez votre compte </span></h2>
                                <br><br>
                                <form method="POST" action="treatment_sign_up.php">
                                <div class="form-floating mb-3">
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button name="sign_up" class="btn btn-primary" type="submit">Envoyer</button></div>
                                </form>
                                </div>
                            </div>
                        </div>
