                    ...
                    <div class="bg-light rounded-4 py-5 px-4 px-md-5">
                        <div class="text-center mb-5">
                            <div class="d-flex justify-content-center mb-4"><img src="assets/lettre.png" width="100" height="100" alt=""></div>
                                <h1 class="fw-bolder"> Cette adresse email semble déjà prise 😰</h1><br>
                                <a href="sign_up.php"><button action="" name="back" class="btn btn-primary" type="submit">réssayer</button></a>
                            </div>
                </div><br><br>
